...
public class LibrariesUI
{
    ...
    private void cancelChanges()
    {
        ...
        {
            ((LibMeta) configModel.getValueAt(i, 0)).setDataHasChanged(false);
        }
    ...
    private void initialize()
    {
        ...
        configModel = new ConfigModel(context, displayName);
    ...
    private void loadOptions()
    {
        ...
        {
            LibMeta libMeta = (LibMeta) configModel.getValueAt(currentConfigIndex, 0);
            ((CardLayout) mf.generalTab.getLayout()).show(mf.generalTab, libMeta.card.name().toLowerCase());
        }
    }
