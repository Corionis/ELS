@echo off
REM Run ELS as a stand-alone local duplicates process
REM
...
java -jar %base%\..\ELS.jar -d debug --dryrun --duplicates --validate -p ..\meta\publisher.json ..\output\%name%-%dtime%.log
