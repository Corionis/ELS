...
java -jar %base%\..\ELS.jar -d debug --remote S --authorize password -p ..\meta\publisher.json -s  ..\meta\subscriber.json -T ..\meta\subscriber-targets.json -f ..\output\%name%-%dtime%.log
