...
java -jar %base%\..\ELS.jar -d debug --remote L --authorize password -p ..\meta\publisher.json -S  ..\meta\subscriber.json -T ..\meta\subscriber-targets.json -f ..\output\%name%-%dtime%.log
