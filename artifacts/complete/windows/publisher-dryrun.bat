...
java -jar %base%\..\ELS.jar -d debug --dry-run --remote P -p ..\meta\publisher.json -s  ..\meta\subscriber.json -t ..\meta\targets.json -m ..\output\%name%-Mismatches.txt -n ..\output\%name%-WhatsNew.txt -f ..\output\%name%.log
