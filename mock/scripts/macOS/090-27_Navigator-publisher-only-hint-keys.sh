...
rt/Contents/Home/bin/java -jar bin/ELS.jar -C . --navigator -c debug -d debug -k system/hint.keys -P libraries/publisher.json -F output/090-26_Navigator-hint-keys.log
